...
[assembly: ExportRenderer(typeof(GesturesContentView), typeof(HitachiDemo.iOS.iOSDepService.GesturesContentViewRenderer))]
namespace HitachiDemo.iOS.iOSDepService
{
    /// <summary>
    ...
    public class GesturesContentViewRenderer : ViewRenderer<GesturesContentView, UIView>
    {
        ...
        {            
            ...
            }) { Direction = UISwipeGestureRecognizerDirection.Right, NumberOfTouchesRequired = 1 });
        }
